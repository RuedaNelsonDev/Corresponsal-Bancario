...
public class MostrarTarjeta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAceptar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(MostrarTarjeta.this, MenuAdministrador.class);
    ...
    void agregarTransaccion() {
        ...
        transaccion.setCedulaRemitente("Administrador");
